					...
					<div className="col-lg-7 ps-0 my-auto">
						<div className="card-body text-left">
							<div className="p-md-0 pt-3">
								...
								<p className="text-uppercase text-sm font-weight-bold mb-2">
									{role}
								</p>
							</div>
							...
							<div>
								{linkedinUrl && (
									<a
										href={linkedinUrl}
										target="_blank"
										className="btn btn-linkedin btn-simple btn-lg mb-0 px-2">
										<i
								...
								{githubUrl && (
									<a
										...
										className="btn btn-github btn-simple btn-lg mb-0 px-2">
										<i
